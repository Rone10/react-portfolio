...
const ProjectCard = (props) => {
    ...
    return <div id="projects" className=" pt-10 w-full md:w-4/5 mx-auto  text-white">
        <h1 className="text-5xl font-bold text-center ">My Projects</h1>

        {
            props.items.map(item => {

                return <div key={item.id} className=" overflow-hidden border-b-2 rounded-3xl p-10   mt-10 flex flex-col md:flex-row shadow-sm hover:shadow-xl">
